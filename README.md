...
- InstancedSkinnedMeshComponent input support(UE >= 5.6), allow working with together with **Megaplants**/Procedural Vegetation.
...
- **unreal_uproperty_*** support dict and array attributes, almost everything could be set, way more powerful than official plugin.
...
- Support **InstancedSkinnedMeshComponent** output, See [he_example_kinefx_output.hda](https://github.com/AdrianPanGithub/HoudiniEngineForUnreal/blob/HEAD/Resources/houdini/otls/examples/he_example_kinefx_output.hda)(UE >= 5.7.1), allow working with together with **Megaplants**/Procedural Vegetation.
...
| unreal_uproperty_ActorLocation | point/vertex/prim/detail | vector3 | (Output) Assign the actor location, useful for centerize split actors, See [he_example_split_actors.hda](https://github.com/AdrianPanGithub/HoudiniEngineForUnreal/blob/HEAD/Resources/houdini/otls/examples/he_example_split_actors.hda) |
